...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 20 Ara 2021, 16:45:09
...
--
-- Veritabanı: `hospitalsystem`
--
CREATE DATABASE IF NOT EXISTS `hospitalsystem` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `hospitalsystem`;
...
CREATE TABLE `bolum` (
  ...
  `BolumTAGS` varchar(255) NOT NULL
...
INSERT INTO `bolum` (`BolumID`, `BolumADI`, `BolumTAGS`) VALUES
(1, 'Ağız, Çene ve Diş Sağlığı', 'Diş,çene,ağız,dolgu,kanal tedavisi,yanak,apse,çürük,sızlama'),
(2, 'Beyin ve Sinir Cerrahisi', 'Başım ağrıyor,Sunizit,Migren,Çatlama,boyun'),
(3, 'Göğüs Hastalıkları ve Alerji', 'Solunum,alerji,deri,besin,göz,saman,astım,Toz'),
(4, 'Çocuk Sağlığı ve Hastalıkları', 'Enfeksiyon,Bronşit,Cocuk,Çocuk,Hastalıkları,Evde,Bademcik'),
(5, 'İç Hastalıkları (Dahiliye)', 'Kolesterol,Karaciğer,Akciğer,safra,Diyabet'),
(6, 'Üroloji', 'Tuvalet Zorluğu,kısırlık,Taş,böbrek taşı,prostat,penis'),
(7, 'Radyoloji', 'Rontgen,meme,yaralanma,acil,damar,kalp,osteoporozun');
...
CREATE TABLE `doktorlar` (
  ...
  `DoktorDERECE` varchar(255) NOT NULL,
  `DoktorNO` varchar(255) NOT NULL,
  `DoktorADI` varchar(255) NOT NULL,
  `DoktorSOYADI` varchar(255) NOT NULL,
  `BolumADI` varchar(255) DEFAULT NULL,
  `HastaneADI` varchar(255) DEFAULT NULL,
  `DoktorCinsiyet` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `doktorlar` (`DoktorID`, `DoktorDERECE`, `DoktorNO`, `DoktorADI`, `DoktorSOYADI`, `BolumADI`, `HastaneADI`, `DoktorCinsiyet`) VALUES
(1, 'Doc Dr.', '0101012021', 'Melih ', 'Yaras', 'Ağız, Çene ve Diş Sağlığı', 'Seyhan Devlet Hastanesi', 'Erkek'),
(2, 'Doc Dr.', '0101022021', 'Yeliz', 'Okur', 'Beyin ve Sinir Cerrahisi', 'Seyhan Devlet Hastanesi', 'Kadin'),
(3, 'Doc Dr', '0101032021', 'Kerim', 'Sargun', 'Göğüs Hastalıkları ve Alerji', 'Seyhan Devlet Hastanesi', 'Erkek'),
(4, 'Prof Doc Dr', '0101042021', 'Cengizhan', 'Kurtulus', 'Radyoloji', 'Seyhan Devlet Hastanesi', 'Erkek'),
(5, 'Doc Dr', '0101052021', 'Semih', 'Terzi', 'Çocuk Sağlığı ve Hastalıkları', 'Seyhan Devlet Hastanesi', 'Erkek'),
(6, 'Doc Dr', '0101062021', 'Gamze', 'Ok', 'İç Hastalıkları (Dahiliye)', 'Seyhan Devlet Hastanesi', 'Kadin'),
(7, 'Prof Doc Dr', '0101072021', 'Rasim', 'Menguc', 'Çocuk Sağlığı ve Hastalıkları', 'Seyhan Devlet Hastanesi', 'Erkek'),
(8, 'Doc Dr', '0102072021', 'Kemal', 'Sira', 'Göğüs Hastalıkları ve Alerji', 'İmamoğlu Devlet Hastanesi', 'Erkek'),
(9, 'Doc Dr', '0103072021', 'Cengiz', 'Temiz', 'Üroloji', 'Pozantı Devlet Hastanesi', 'Erkek'),
(10, 'Doc Dr', '0104072021', 'Gözde', 'Toy', 'Üroloji', 'Ceyhan Devlet Hastanesi', 'Kadin');
...
CREATE TABLE `hasta` (
  ...
  `HastaTC` varchar(255) NOT NULL,
  `HastaADI` varchar(255) NOT NULL,
  `HastaSOYADI` varchar(255) NOT NULL,
  `HastaPASSWORD` varchar(255) NOT NULL,
  `HastaIlName` varchar(255) NOT NULL,
  `HastaDOGUMTARIHI` date NOT NULL,
  `HastaKANGRUBU` varchar(255) DEFAULT NULL,
  `HastaCINSIYETI` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `hasta` (`HastaID`, `HastaTC`, `HastaADI`, `HastaSOYADI`, `HastaPASSWORD`, `HastaIlName`, `HastaDOGUMTARIHI`, `HastaKANGRUBU`, `HastaCINSIYETI`) VALUES
(8, '32123221321', 'Melek', 'Demir', '123123123123', 'Antakya', '1998-06-21', 'Arh+', 'Kadin'),
(9, '30103851500', 'Furkan', 'Uysal', '123123123123', 'ANKARA', '1111-02-05', 'Arh+', 'Erkek'),
(19, '12345678911', 'KADİR', 'MAZLUM', '123456', 'ADANA', '1998-10-10', '0rh+', 'Erkek'),
(21, '12345678913', 'Kadir', 'ümit', '123456', 'Mersin', '1998-05-05', '0rh+', 'Erkek'),
(22, '12345678914', 'ÜMİT', 'MAZLUM', '123456', 'MERSİN', '1998-11-11', '0rh+', 'Erkek');
...
CREATE TABLE `hastaneler` (
  ...
  `HastaneADI` varchar(255) NOT NULL,
  `HastaneIL` varchar(255) NOT NULL,
  `HastaneILCE` varchar(255) NOT NULL,
  `HastaneDURUMU` varchar(255) NOT NULL,
  `HastaneADRESI` varchar(255) NOT NULL,
  `HastaneTEL` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `hastaneler` (`HastaneID`, `HastaneADI`, `HastaneIL`, `HastaneILCE`, `HastaneDURUMU`, `HastaneADRESI`, `HastaneTEL`) VALUES
(1, 'Adana Şehir Hastanesi', 'ADANA', 'YÜREĞİR', 'DEVLET', 'Kışla Mahallesi, Dr. Mithat Özsan Bulvarı, 4522. Sokak No:1, Yüreğir/Adana', '(0322) 455 90 00'),
(2, 'Ceyhan Devlet Hastanesi', 'ADANA', 'CEYHAN', 'DEVLET', 'Cumhuriyet Mah, Prof. Dr. Kemal Dal Cd. No:87, 01940 Ceyhan/Adana', '(0322) 613 13 62'),
(3, 'Karaisalı Devlet Hastanesi', 'ADANA', 'KARAİSALI', 'DEVLET', ' Yeni, 01780 Karaisalı/Adana', '(0322) 551 25 24'),
(4, 'Kozan Devlet Hastanesi', 'ADANA', 'KOZAN', 'DEVLET', 'Karacaoğlan, Feke Cd. No:1/150, 01510 Kozan/Adana', '(0322) 515 83 06'),
(5, 'İmamoğlu Devlet Hastanesi', 'ADANA', 'İMAMOĞLU', 'DEVLET', 'Hürriyet Mahallesi Şehit Osman Tatar Cad, D:30, 01700 İmamoğlu/Adana', '(0322) 891 37 01'),
(6, 'Pozantı Devlet Hastanesi', 'ADANA', 'POZANTI', 'DEVLET', 'Zafer Mah. Hastane Cad. No:81 01470-Pozantı, Adana, Türkiye', '0 322 581 39 20'),
(7, 'Seyhan Devlet Hastanesi', 'Adana', 'SEYHAN', 'DEVLET', 'Yenibaraj, Hacı Ömer Sabancı Cd, 01150 Seyhan/Adana', '0322 225 93 29');
...
INSERT INTO `il` (`IlID`, `IlKODU`, `IlADI`) VALUES
(1, 34, 'İSTANBUL'),
(2, 6, 'ANKARA'),
(3, 35, 'İZMİR'),
(4, 16, 'BURSA'),
...
INSERT INTO `ilce` (`IlceID`, `IlceADI`, `IlceKEY`, `IlKODU`) VALUES
(1, 'ADALAR', 1103, 34),
...
CREATE TABLE `randevu` (
  ...
  `RandevuSaat` varchar(255) NOT NULL,
  `RandevuTarih` date NOT NULL,
  `RandevuTC` varchar(255) NOT NULL,
  `RandevuIlADI` varchar(255) NOT NULL,
  `RandevuIlceADI` varchar(255) NOT NULL,
  `RandevuHastaneADI` varchar(255) NOT NULL,
  `RandevuBolumADI` varchar(255) NOT NULL,
  `RandevuDoktorNAME` varchar(255) NOT NULL,
  `RandevuDoktorSURNAME` varchar(255) NOT NULL,
  `RandevuCONTROL` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `randevu` (`RandevuID`, `RandevuSaat`, `RandevuTarih`, `RandevuTC`, `RandevuIlADI`, `RandevuIlceADI`, `RandevuHastaneADI`, `RandevuBolumADI`, `RandevuDoktorNAME`, `RandevuDoktorSURNAME`, `RandevuCONTROL`) VALUES
(21, '09:45', '2021-12-19', '12345678912', 'ADANA', 'SEYHAN', ' Seyhan Devlet Hastanesi', 'Beyin ve Sinir Cerrahisi', 'Yeliz', 'Okur', '09:452021-12-1912345678912Beyin ve Sinir Cerrahisi'),
(22, '11:00', '2021-12-19', '12345678912', 'ADANA', 'SEYHAN', ' Seyhan Devlet Hastanesi', 'Radyoloji', 'Cengizhan', 'Kurtulus', '11:002021-12-1912345678912Radyoloji'),
(26, '13:00', '2021-12-20', '12345678914', 'ADANA', 'SEYHAN', ' Seyhan Devlet Hastanesi', 'Ağız, Çene ve Diş Sağlığı', 'Melih', '', '13:002021-12-2012345678914Ağız, Çene ve Diş Sağlığı'),
(27, '09:00', '2021-12-20', '12345678914', 'ADANA', 'SEYHAN', ' Seyhan Devlet Hastanesi', 'Radyoloji', 'Cengizhan', 'Kurtulus', '09:002021-12-2012345678914Radyoloji');
...
ALTER TABLE `bolum`
  ...
  ADD UNIQUE KEY `BolumADI` (`BolumADI`);
...
ALTER TABLE `doktorlar`
  ...
  ADD UNIQUE KEY `DoktorNO` (`DoktorNO`),
  ADD KEY `BolumADI` (`BolumADI`),
...
ALTER TABLE `hastaneler`
  ...
  ADD UNIQUE KEY `HastaneADI` (`HastaneADI`);
...
ALTER TABLE `il`
  ...
  ADD UNIQUE KEY `IlKODU` (`IlKODU`),
  ADD UNIQUE KEY `IlADI` (`IlADI`);
...
ALTER TABLE `randevu`
  ...
  ADD UNIQUE KEY `RandevuCONTROL` (`RandevuCONTROL`);
...
--
ALTER TABLE `hasta`
  MODIFY `HastaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- Tablo için AUTO_INCREMENT değeri `hastaneler`
--
ALTER TABLE `hastaneler`
  MODIFY `HastaneID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `ilce`
  MODIFY `IlceID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=971;

--
-- Tablo için AUTO_INCREMENT değeri `randevu`
--
ALTER TABLE `randevu`
  MODIFY `RandevuID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `doktorlar`
  ADD CONSTRAINT `doktorlar_ibfk_1` FOREIGN KEY (`BolumADI`) REFERENCES `bolum` (`BolumADI`),
...
--
ALTER TABLE `ilce`
  ADD CONSTRAINT `ilce_ibfk_1` FOREIGN KEY (`IlKODU`) REFERENCES `il` (`IlKODU`);
COMMIT;
